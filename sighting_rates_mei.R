...
setwd("//crcdata1/RedirectedFolders/dbarrios/My Documents/ENSO_paper/Sightings/Sighting_rates/Monthly")
...
setwd("//crcdata1/RedirectedFolders/dbarrios/My Documents/ENSO_paper/Sightings/Sighting_rates/Yearly")
...
setwd("//crcdata1/RedirectedFolders/dbarrios/My Documents/ENSO_paper/R_organized/CSVs")
...
setwd("//crcdata1/RedirectedFolders/dbarrios/My Documents/beaked whales project/ENSOSTUFF")
...
setwd("//crcdata1/RedirectedFolders/dbarrios/My Documents/ENSO_paper/Sightings/Sighting_rates/PDO")
...
#neutral phase sighting rates
counts_neut <- counts_neut %>% 
  group_by(constantneut) %>% 
  count()
#thneut to find effort per 100 hr
constantneut <- (count(mid100hour)*5)/60
constantneut <- as.numeric(constantneut)
counts_neut$effby100 <- ((counts_neut$n)/constantneut)*100
counts_neut$ENSO <- "Neutral"
